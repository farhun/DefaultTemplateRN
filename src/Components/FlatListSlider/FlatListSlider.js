    ...
    return (
      <View>
        <FlatList
          ...
          snapToInterval={totalItemWidth + this.props.snapToIntervalCount}
          ...
          renderItem={({ item, index }) =>
            React.cloneElement(this.props.component, {
              ...
              viewImageBorderRadius: this.props.viewImageBorderRadius,
              viewImagePadding: this.props.viewImagePadding
            })
          }
          ...
          onScrollToIndexFailed={info => {
            ...
            wait.then(() => {
              this.slider.current?.scrollToIndex({ index: info.index, animated: true });
            });
          }}
        />
